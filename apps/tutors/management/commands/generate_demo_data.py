...
class Command(BaseCommand):
    ...
    def create_tutors(self, count, subjects):
        ...
        last_names = [
            ...
            'Иванова', 'Петрова', 'Сидорова', 'Козлова', 'Волкова', 'Смирнова', 'Попова', 'Лебедева', 'Новикова', 'Морозова'
        ]
        ...
        for i in range(count):
            ...
            bio_templates = [
                ...
                f"Кандидат наук, {experience} лет преподавательской деятельности. Индивидуальный подход к каждому ученику.",
